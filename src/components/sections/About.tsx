      ...
      <div className="grid gap-8 md:gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-12">
        <div className="max-w-3xl space-y-5 sm:space-y-6">
          <p className="paragraph">
            ...
            responsive, and accessible web applications that deliver great user
            experiences.
          </p>

          <p className="paragraph">
            I enjoy turning ideas into reliable software by developing intuitive
            user interfaces, integrating REST APIs, and writing clean,
            maintainable code. I'm committed to continuous learning and
